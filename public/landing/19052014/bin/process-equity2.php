...
//LP Patent Litigation Support
if ((isset($_POST['url'])) && (strlen(trim($_POST['url'])) == '') && $formname == 'Patent Litigation Support') {
$post1 = new ActonConnection;
$post1->setPostItems('firstname',$_REQUEST['firstname']);
$post1->setPostItems('lastname',$_REQUEST['lastname']);
$post1->setPostItems('company',$_REQUEST['company']);
...
$post1->setPostItems('utm_content',$_REQUEST['utm_content']);
$post1->setPostItems('utm_campaign',$_REQUEST['utm_campaign']);
$post1->processConnection('http://connect.aranca.com/acton/eform/17562/0013/d-ext-0001');
} else {
header('Location: http://www.aranca.com/');
}

//LP Financial opinions and Advisory
if ((isset($_POST['url'])) && (strlen(trim($_POST['url'])) == '') && $formname == 'Financial opinions and Advisory') {
$post1 = new ActonConnection;
$post1->setPostItems('firstname',$_REQUEST['firstname']);
$post1->setPostItems('lastname',$_REQUEST['lastname']);
$post1->setPostItems('company',$_REQUEST['company']);
...
$post1->setPostItems('utm_content',$_REQUEST['utm_content']);
$post1->setPostItems('utm_campaign',$_REQUEST['utm_campaign']);
$post1->processConnection('http://connect.aranca.com/acton/eform/17562/0015/d-ext-0001');
} else {
header('Location: http://www.aranca.com/');
}

//LP Patent Monetization and Licensing Support
if ((isset($_POST['url'])) && (strlen(trim($_POST['url'])) == '') && $formname == 'Patent Monetization and Licensing Support') {
$post1 = new ActonConnection;
$post1->setPostItems('firstname',$_REQUEST['firstname']);
$post1->setPostItems('lastname',$_REQUEST['lastname']);
$post1->setPostItems('company',$_REQUEST['company']);
...
$post1->setPostItems('utm_content',$_REQUEST['utm_content']);
$post1->setPostItems('utm_campaign',$_REQUEST['utm_campaign']);
$post1->processConnection('http://connect.aranca.com/acton/eform/17562/0016/d-ext-0001');
} else {
header('Location: http://www.aranca.com/');
}

//LP Editorial Services
if ((isset($_POST['url'])) && (strlen(trim($_POST['url'])) == '') && $formname == 'Editorial Services') {
$post1 = new ActonConnection;
$post1->setPostItems('firstname',$_REQUEST['firstname']);
$post1->setPostItems('lastname',$_REQUEST['lastname']);
$post1->setPostItems('company',$_REQUEST['company']);
...
$post1->setPostItems('utm_content',$_REQUEST['utm_content']);
$post1->setPostItems('utm_campaign',$_REQUEST['utm_campaign']);
$post1->processConnection('http://connect.aranca.com/acton/eform/17562/0019/d-ext-0001');
} else {
header('Location: http://www.aranca.com/');
}

//Intellectual Property Valuation Services
if ((isset($_POST['url'])) && (strlen(trim($_POST['url'])) == '') && $formname == 'Intellectual Property Valuation Services') {
$post1 = new ActonConnection;
$post1->setPostItems('firstname',$_REQUEST['firstname']);
$post1->setPostItems('lastname',$_REQUEST['lastname']);
$post1->setPostItems('company',$_REQUEST['company']);
...
$post1->setPostItems('utm_content',$_REQUEST['utm_content']);
$post1->setPostItems('utm_campaign',$_REQUEST['utm_campaign']);
$post1->processConnection('http://connect.aranca.com/acton/eform/17562/001a/d-ext-0001');
} else {
header('Location: http://www.aranca.com/');
}
